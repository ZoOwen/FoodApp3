package sqlfoodapp.zoowen.foodapp3.ui.cart;
...
import sqlfoodapp.zoowen.foodapp3.Adapter.MyCartAdapter;
import sqlfoodapp.zoowen.foodapp3.Common.Common;
import sqlfoodapp.zoowen.foodapp3.Common.MySwipeHelper;
...
import sqlfoodapp.zoowen.foodapp3.EventBus.UpdateItemInCart;
            ...
            cartDataSource.UpdateCartItems(event.getCartItem())
                    ...
                    .subscribe(new SingleObserver<Integer>() {
                        ...
                        public void onSuccess(Integer integer) {
                            calculateTotalPrice();
                            recycler_cart.getLayoutManager().onRestoreInstanceState(recyclerViewState); //fix error refresh re
                        }
