package com.zoowen.foodapp3.Adapter;
...
import com.zoowen.foodapp3.CallBack.IRecyclerClickListener;
...
public class MyCategoriesAdapter extends RecyclerView.Adapter<MyCategoriesAdapter.MyViewHolder> {
    ...
    public MyCategoriesAdapter(Context context, List<CategoryModel> createCategoryModelList) {
        this.context = context;
        categoryModelList = createCategoryModelList;
    }
